...
ipcMain.handle('pick-folder', async () => {
  // Default the picker to Downloads (where media folders usually live) so it
  // doesn't reopen at the last-used folder, which makes it look like the same
  // folder keeps opening. macOS remembers the last location otherwise.
  let defaultPath;
  try {
